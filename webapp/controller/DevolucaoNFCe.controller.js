sap.ui.define([
  ...
  function (BaseController, JSONModel, MessageBox) {
    ...
    return BaseController.extend("arcelor.controller.DevolucaoNFCe", {
      /**
       ...
       */
       onInit: function () {
        if (!this.getModel("devolucaoNFCe")) {
          this.setModel(
            new JSONModel({
              motivo: "",
              motivos: [{
      ...
      _onMasterMatched: function () {
        // this.getModel("devolucaoNFCe").setData({
        //   motivo: "",
        //   motivos: [{
        //     key: "05",
        //     text: "Erro na Ordem de Vendas"
        ...
        //   ordemVenda: "123456",
        // });
        // this.getModel("devolucaoNFCe").refresh(true);
      },
      ...
      onDevolucaoNFCe: function () {
        var sMotivo = this.getModel("devolucaoNFCe").getData().motivo;
        this.getOwnerComponent().getRouter().navTo("DevolucaoNFCeParametros");
      },
